...
import com.example.project.mapper.TeamMapper;
...
import com.example.project.model.enums.TeamStatusEnum;
...
public class TeamServiceImpl extends ServiceImpl<TeamMapper, Team>
    ...
    private Team getTeamById(Long teamId) {
        ...
        Object o = valueOperations.get("com.example.project.team.id:" + teamId);
        Team team = null;
        if (o == null){
            team = this.getById(teamId);
            valueOperations.set("com.example.project.team.id:" + teamId,team);
        }else {
            return (Team) o;
        }
        if (team == null) {
